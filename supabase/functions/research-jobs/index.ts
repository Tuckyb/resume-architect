...
const PRESETS: Record<string, string> = {
  AI:
    'current open job roles at the intersection of AI and business/marketing operations, specifically titles such as: AI Content Operations Manager, AI Enablement Manager, AI Enablement Specialist, AI Adoption Lead, AI Adoption Specialist, AI Program Manager, AI Operations Manager, AI Innovation Lead, AI Transformation Consultant, AI Transformation Manager, AI Growth Manager, AI Solutions Consultant, AI Marketing Specialist, AI Marketing Manager, Director of AI Marketing, AI Content Strategist, AI Automation Specialist, Conversational AI Strategist, Conversational AI Manager, Agentic Workflow Designer, Digital Transformation Manager, Digital Transformation Consultant, AI Consultant, Solutions Consultant, Solutions Engineer, Implementation Consultant, Technical Account Manager, Business Analyst, Fractional CMO + AI Advisor',
  Marketing:
    'current open job roles in marketing, marketing operations and revenue/growth, specifically titles such as: Marketing Assistant, Marketing Coordinator, Marketing Executive, Digital Marketing Assistant, Digital Marketing Specialist, Marketing Specialist, Marketing Manager, Communications Assistant, Communications Coordinator, Communications Manager, PR Assistant, PR Manager, Social Media Coordinator, Social Media Manager, Content Coordinator, Content Marketing Manager, Campaign Coordinator, Campaign Manager, Brand Manager, Ecommerce Marketing Manager, Customer Marketing Manager, Growth Marketing Manager, Acquisition Manager, CRM Coordinator, CRM Manager, Lifecycle Marketing Manager, Marketing Operations Coordinator, Marketing Automation Specialist, Marketing Technology Specialist, Marketing Systems Architect, Revenue Operations Manager, Revenue Operations Specialist, Business Systems Specialist, Head of Marketing Operations, Product Marketing Coordinator, Product Marketing Specialist, Product Marketing Manager, Product Marketing Manager (AI), Customer Success Manager, Customer Experience Manager, Customer Experience Automation Manager',
}
